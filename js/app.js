...
const ROUTES = [
  ...
  { pattern: /^\/publicar$/, view: (app, m, query) => viewPublicar(app, query) },
  { pattern: /^\/busco-viaje$/, view: (app, m, query) => viewBuscoViaje(app, query) },
  ...
  { pattern: /^\/terminos$/, view: (app) => viewTerminos(app) },
  { pattern: /^\/privacidad$/, view: (app) => viewPrivacidad(app) },
